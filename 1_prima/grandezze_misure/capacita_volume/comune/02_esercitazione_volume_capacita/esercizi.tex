...
\begin{soluzione}
  ...
  \begin{itemize}
    ...
    \item \textbf{Bicchieri:} $6 \times 20\unita{cl} = 120\unita{cl} = 1{,}2\unita{l}$
    \item \textbf{Totale:} $1{,}5\unita{l} + 2\unita{l} + 1{,}2\unita{l} = 4{,}7\unita{l}$
  \end{itemize}
  \textbf{Risposta:} In tutto ci sono $4{,}7$ litri di bevande.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Risposta:} La scorta d'acqua durerà per $5$ giorni.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Risposta:} Si possono preparare $40$ caffè prima di riempire nuovamente il serbatoio.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Risposta:} a) $1{,}2\unita{l}$; b) $1{,}2\unita{dm^3}$; c) $1200\unita{cm^3}$.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \]
  \end{enumerate}
  \textbf{Risposta:} a) $0{,}42\unita{l}$; b) $420\,000\unita{mm^3}$.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Risposta:} a) $3000\unita{cm^3}$; b) $3$ litri.
\end{soluzione}
\end{esercizio}
\newpage
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \]
  \end{enumerate}
  \textbf{Risposta:} Sono necessari $151\,200$ litri d'acqua.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \item Troviamo l'altezza dell'acqua dividendo il volume per l'area di base:
    \[
    h = \frac{V}{A_b} = \frac{30\unita{dm^3}}{12\unita{dm^2}} = 2{,}5\unita{dm} = 25\unita{cm}
    \]
  \end{enumerate}
  \textbf{Risposta:} L'acqua raggiunge un'altezza di $25\unita{cm}$ (o $2{,}5\unita{dm}$).
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Risposta:} a) $56\unita{dm^2}$ di latta; b) $40\unita{dm^3}$; c) $40$ litri.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \item Troviamo l'altezza raggiunta dall'acqua:
    \[
  ...
  \end{enumerate}
  \textbf{Risposta:} L'altezza totale della vasca è di $28\unita{cm}$.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \item Sappiamo che $V = \text{lunghezza} \times \text{larghezza} \times \text{profondità}$.\\
    Impostiamo la formula inversa per trovare la lunghezza ($l$):
    \[
    l = \frac{V}{\text{larghezza} \times \text{profondità}} = \frac{240\unita{m^3}}{8\unita{m} \times 2\unita{m}} = \frac{240}{16} = 15\unita{m}
    \]
  \end{enumerate}
  \textbf{Risposta:} La piscina è lunga $15$ metri.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \item Dividiamo il volume per la portata dei rubinetti per ottenere il tempo in minuti:
    \[
    t = \frac{18\,000\unita{l}}{9\unita{l/min}} = 2000\text{ minuti}
    \]
    \item Esprimiamo il tempo in ore dividendo per $60$:
    \[
    2000\text{ min} = 33\text{ ore e } 20\text{ minuti} \quad (\text{poiché } 33 \times 60 = 1980\text{ min})
    \]
  \end{enumerate}
  \textbf{Risposta:} Saranno necessarie $33$ ore e $20$ minuti per riempire la vasca.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Risposta:} i) $256\unita{ml}$ di tè; ii) Il contenitore di Antonio richiede più cartone.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \item Troviamo l'altezza (profondità):
    \[
    h = \frac{V}{A_b} = \frac{112{,}5\unita{m^3}}{375\unita{m^2}} = 0{,}3\unita{m} = 30\unita{cm}
    \]
  \end{enumerate}
  \textbf{Risposta:} La piscina ha una profondità di $30\unita{cm}$ (o $0{,}3$ metri).
\end{soluzione}
\end{esercizio}
\newpage
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \]
    \item Esprimiamo il valore anche in decimetri cubi e litri per completezza: $600\unita{cm^3} = 0{,}6\unita{dm^3} = 0{,}6\unita{l}$.
  \end{enumerate}
  \textbf{Risposta:} Il volume dell'oggetto immerso è di $600\unita{cm^3}$ (o $0{,}6\unita{dm^3}$).
\end{soluzione}
\end{esercizio}
