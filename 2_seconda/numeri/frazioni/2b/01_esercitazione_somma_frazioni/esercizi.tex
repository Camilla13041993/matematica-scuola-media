...
\begin{tikzpicture}[scale=1.1, every node/.style={scale=0.9}]
  ...
  \ifsoluzioni
    ...
    \draw[<-] (1.5, 1.5) -- (-0.8, 1.5) node[left, scale=0.8] {Succo d'arancia ($\frac{1}{3}\unita{l}$)};
    ...
    \draw[<-] (1.5, 3.375) -- (3.8, 3.375) node[right, scale=0.8] {Succo di mela ($\frac{1}{2}\unita{l}$)};
...
\vspace{0.1cm}
\noindent\colorbox{red!5}{%
\parbox{0.965\linewidth}{\vspace{0.1cm}\textbf{Attenzione!} Non possiamo sommare frazioni con parti di grandezza diversa (denominatori diversi). Dobbiamo prima trasformarle in frazioni equivalenti con lo stesso denominatore (calcolando il m.c.m.).\vspace{0.1cm}}}
\vspace{0.1cm}
...
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm, noitemsep]
  ...
  \item Adatta i numeratori e i denominatori:
    $$\frac{1}{2} = \frac{1 \cdot 3}{2 \cdot 3} = \frac{3}{6} \qquad \text{e} \qquad \frac{1}{3} = \frac{1 \cdot 2}{3 \cdot 2} = \frac{2}{6}$$
...
\vspace{0.1cm}
\noindent\colorbox{red!5}{%
\parbox{0.965\linewidth}{\vspace{0.1cm}\textbf{Attenzione!} Non possiamo sottrarre frazioni con parti di grandezza diversa (denominatori diversi). Dobbiamo prima trasformarle in frazioni equivalenti con lo stesso denominatore (calcolando il m.c.m.).\vspace{0.1cm}}}
\vspace{0.1cm}
