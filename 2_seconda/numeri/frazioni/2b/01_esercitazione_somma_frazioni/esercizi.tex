...
\begin{tikzpicture}[scale=1.1, every node/.style={scale=0.9}]
  ...
  \ifsoluzioni
    ...
    \path[fill=red!40!white] (0,0) to[out=-20,in=200] (3,0) -- (3, 0.75) to[out=200,in=-20] (0, 0.75) -- cycle;
    \draw[red!80!black] (1.5, 0.375) node {\small Sciroppo di fragola ($\frac{1}{6}\unita{l}$)};
    
    % 2/6 orange juice (orange) from y=0.75 to y=2.25
    \path[fill=orange!50!white] (0,0.75) to[out=-20,in=200] (3,0.75) -- (3, 2.25) to[out=200,in=-20] (0, 2.25) -- cycle;
    \draw[orange!85!black] (1.5, 1.5) node {\small Succo d'arancia ($\frac{1}{3}\unita{l}$)};
    
    % 3/6 apple juice (yellow) from y=2.25 to y=4.5
    \path[fill=yellow!45!white] (0,2.25) to[out=-20,in=200] (3,2.25) -- (3, 4.5) to[out=200,in=-20] (0, 4.5) -- cycle;
    \draw[yellow!80!black!80!red] (1.5, 3.375) node {\small Succo di mela ($\frac{1}{2}\unita{l}$)};
...
\begin{soluzione}
  ...
  \begin{enumerate}[label=\alph*)]
    \item \textbf{Rappresentazione grafica:} Troviamo il comune denominatore per posizionare gli ingredienti nel cilindro graduato in sesti:
      \begin{itemize}
        \item Sciroppo di fragola: $\frac{1}{6}\unita{l}$ ($1$ parte su $6$)
        \item Succo d'arancia: $\frac{1}{3} = \frac{2}{6}\unita{l}$ ($2$ parti su $6$)
        \item Succo di mela: $\frac{1}{2} = \frac{3}{6}\unita{l}$ ($3$ parti su $6$)
      \end{itemize}
      Nel cilindro si colorano dal basso: la prima sezione in rosso (fragola), le successive due sezioni in arancione (arancia), e le ultime tre sezioni in giallo (mela), riempiendo il cilindro fino a $\frac{6}{6}\unita{l}$ (1 litro).
    \item \textbf{Frazione totale di liquido:} Sommiamo le quantità:
      \[
      \frac{1}{2} + \frac{1}{3} + \frac{1}{6} = \frac{3}{6} + \frac{2}{6} + \frac{1}{6} = \frac{3+2+1}{6} = \frac{6}{6} = 1\unita{l}
      \]
      Sì, si ottiene esattamente $1$ litro di cocktail.
    \item \textbf{Fabbisogno per la classe:}
      \begin{itemize}
        \item Quantità totale per 24 studenti: $24 \times \frac{1}{4}\unita{l} = \frac{24}{4}\unita{l} = 6\unita{l}$.
        \item Poiché una singola ricetta base produce esattamente $1\unita{l}$ di liquido, per preparare $6\unita{l}$ totali sarà necessario ripetere la ricetta esattamente \textbf{$6$ volte}.
      \end{itemize}
  \end{enumerate}
  \textbf{Risposta:} b) $1\unita{l}$ (esattamente un litro); c) Servono $6\unita{l}$ di cocktail in totale e la ricetta va ripetuta $6$ volte.
\end{soluzione}
\end{esercizio}
...
\textbf{1. Perché? (Il motivo visivo)}
...
\textbf{2. Come si calcola? (Esempio guidato)}
$$\frac{3}{4} + \frac{1}{6}$$
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm, noitemsep]
  \item \textbf{Denominatore comune} (m.c.m. tra $4$ e $6$): \ \textbf{12}
  \item \textbf{Adatta i numeratori}:
    $$\frac{3}{4} = \frac{3 \times 3}{12} = \frac{9}{12} \qquad \text{e} \qquad \frac{1}{6} = \frac{1 \times 2}{12} = \frac{2}{12}$$
  \item \textbf{Somma i numeratori}:
...
\begin{soluzione}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Mattone superiore (cima):} somma dei due mattoni intermedi:
      ...
      \]
  \end{enumerate}
  \textbf{Soluzione nei mattoni (dal basso in alto):} $\frac{1}{2}$, $\frac{17}{30}$ e, sulla cima, $\frac{16}{15}$.
\end{soluzione}
\end{esercizio}
...
\begin{esercizio}{Uguaglianze e valore ignoto}
Risolvi le seguenti uguaglianze determinando il valore della lettera $x$. Semplifica i risultati quando possibile.

\vspace{0.3cm}
\renewcommand{\arraystretch}{2.25}
\begin{tabularx}{\linewidth}{|X|X|}
\hline
a) $\frac{2}{3} + x = \frac{7}{3}$ & b) $x - \frac{3}{5} = \frac{1}{15}$ \\
\hline
c) $x + \frac{1}{5} = \frac{3}{5}$ & d) $\frac{4}{7} - x = \frac{5}{14}$ \\
\hline
\end{tabularx}
\vspace{0.3cm}
...
\begin{soluzione}
  \textbf{Risoluzione delle uguaglianze per determinare $x$:}
  \begin{enumerate}[label=\alph*)]
    \item Per trovare $x$, sottraiamo $\frac{2}{3}$ dal totale:
      \[
      x = \frac{7}{3} - \frac{2}{3} = \frac{7-2}{3} = \frac{5}{3}
      \]
    \item Per trovare $x$, sommiamo $\frac{3}{5}$ al risultato. Troviamo il comune denominatore ($15$):
      \[
      x = \frac{1}{15} + \frac{3}{5} = \frac{1}{15} + \frac{9}{15} = \frac{10}{15} = \frac{2}{3}
      \]
    \item Per trovare $x$, sottraiamo $\frac{1}{5}$ dal totale:
      \[
      x = \frac{3}{5} - \frac{1}{5} = \frac{2}{5}
      \]
    \item Per trovare $x$, sottraiamo $\frac{5}{14}$ da $\frac{4}{7}$. Troviamo il comune denominatore ($14$):
      \[
      x = \frac{4}{7} - \frac{5}{14} = \frac{8}{14} - \frac{5}{14} = \frac{3}{14}
      \]
  \end{enumerate}
  \textbf{Risposte da inserire:} a) $x = \frac{5}{3}$; b) $x = \frac{2}{3}$; c) $x = \frac{2}{5}$; d) $x = \frac{3}{14}$.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  \textbf{Associazioni corrette:}
  \begin{itemize}
    \item \textbf{1) $\frac{1}{2} + \frac{1}{4} = \frac{2}{4} + \frac{1}{4} = \frac{3}{4}$} $\to$ si associa alla lettera \textbf{B)}
    \item \textbf{2) $\frac{2}{3} - \frac{1}{6} = \frac{4}{6} - \frac{1}{6} = \frac{3}{6} = \frac{1}{2}$} $\to$ si associa alla lettera \textbf{C)}
    \item \textbf{3) $\frac{3}{5} + \frac{1}{10} = \frac{6}{10} + \frac{1}{10} = \frac{7}{10}$} $\to$ si associa alla lettera \textbf{D)}
    \item \textbf{4) $1 - \frac{2}{3} = \frac{3}{3} - \frac{2}{3} = \frac{1}{3}$} $\to$ si associa alla lettera \textbf{A)}
  \end{itemize}
  \textbf{Accoppiamenti finali:} 1-B, 2-C, 3-D, 4-A.
\end{soluzione}
\end{esercizio}
...
\begin{enumerate}[label=\arabic*., leftmargin=1.5cm, noitemsep]
  ...
  \item \textbf{Adatta i numeratori}:
    $$\frac{3}{4} = \frac{3 \times 3}{12} = \frac{9}{12} \qquad \text{e} \qquad \frac{1}{6} = \frac{1 \times 2}{12} = \frac{2}{12}$$
  \item \textbf{Sottrai i numeratori}:
...
\begin{esercizio}{Calcoli con frazioni (livello base)}
Calcola il risultato delle seguenti somme e sottrazioni tra frazioni. Ricordati di ridurre ai minimi termini le frazioni ottenute.
...
\begin{soluzione}
  \textbf{Svolgimento passaggi:}
  \begin{enumerate}[label=\alph*)]
    \item \textbf{Stesso denominatore:} $\frac{5}{12} + \frac{1}{12} = \frac{5+1}{12} = \frac{6}{12} = \frac{1}{2}$
    \item \textbf{Stesso denominatore:} $\frac{7}{10} - \frac{3}{10} = \frac{7-3}{10} = \frac{4}{10} = \frac{2}{5}$
    \item \textbf{Comune denominatore (12):} $\frac{3}{4} + \frac{1}{6} = \frac{9}{12} + \frac{2}{12} = \frac{9+2}{12} = \frac{11}{12}$
    \item \textbf{Comune denominatore (24):} $\frac{5}{6} - \frac{3}{8} = \frac{20}{24} - \frac{9}{24} = \frac{20-9}{24} = \frac{11}{24}$
    \item \textbf{Intero e frazione:} $1 - \frac{3}{7} = \frac{7}{7} - \frac{3}{7} = \frac{7-3}{7} = \frac{4}{7}$
    \item \textbf{Frazione e intero:} $\frac{9}{4} - 2 = \frac{9}{4} - \frac{8}{4} = \frac{9-8}{4} = \frac{1}{4}$
    \item \textbf{Intero e frazione:} $3 - \frac{5}{6} = \frac{18}{6} - \frac{5}{6} = \frac{13}{6}$
    \item \textbf{Frazione e intero:} $\frac{11}{3} - 3 = \frac{11}{3} - \frac{9}{3} = \frac{2}{3}$
  \end{enumerate}
\end{soluzione}
\end{esercizio}
...
\begin{esercizio}{Calcoli con frazioni (livello avanzato)}
Esegui i seguenti calcoli progressivi forniti dal docente di codocenza, semplificando le frazioni e riducendo i risultati ai minimi termini.

\vspace{0.2cm}
\renewcommand{\arraystretch}{2.5}
\begin{tabularx}{\linewidth}{XX}
  a) $\frac{24}{25} - \frac{11}{20} - \frac{1}{4} = \fillbox{2.2cm}$ & b) $\frac{1}{5} + \frac{21}{30} - \frac{1}{6} = \fillbox{2.2cm}$ \\
  c) $5 - \frac{1}{2} + \frac{1}{3} - \frac{1}{6} + \frac{1}{7} = \fillbox{2.2cm}$ & d) $\frac{44}{45} + \frac{17}{30} - \frac{2}{9} + \frac{1}{15} = \fillbox{2.2cm}$ \\
  e) $\frac{35}{50} - \frac{15}{16} + \frac{3}{40} - \frac{5}{200} = \fillbox{2.2cm}$ & f) $\frac{21}{24} - \left(\frac{15}{36} - 1 + \frac{7}{12}\right) = \fillbox{2.2cm}$ \\
  g) $\frac{48}{36} - \left(\frac{55}{44} - \frac{6}{15}\right) = \fillbox{2.2cm}$ & h) $8 - \left(\frac{85}{15} + \frac{5}{6}\right) = \fillbox{2.2cm}$ \\
  i) $\frac{50}{40} - \left(\frac{12}{18} + \frac{8}{32}\right) = \fillbox{2.2cm}$ & l) $\frac{45}{72} - \left(\frac{32}{48} - \frac{10}{25}\right) - \frac{1}{40} = \fillbox{2.2cm}$ \\
  m) $\frac{17}{12} + \frac{55}{66} - \left(2 - \frac{12}{16}\right) = \fillbox{2.2cm}$ & n) $\left(\frac{4}{5} - \frac{4}{12}\right) - \frac{1}{3} + \frac{7}{15} = \fillbox{2.2cm}$ \\
\end{tabularx}
\vspace{0.2cm}
...
\begin{soluzione}
  \textbf{Svolgimento passaggi:}
  \begin{enumerate}[label=\alph*)]
    \item \textbf{Comune denominatore (100):}
      \[
      \frac{24}{25} - \frac{11}{20} - \frac{1}{4} = \frac{24 \times 4 - 11 \times 5 - 1 \times 25}{100} = \frac{96 - 55 - 25}{100} = \frac{16}{100} = \frac{4}{25}
      \]
    \item \textbf{Semplificazione e mcm (30):} Semplifichiamo prima $\frac{21}{30} = \frac{7}{10}$:
      \[
      \frac{1}{5} + \frac{7}{10} - \frac{1}{6} = \frac{1 \times 6 + 7 \times 3 - 1 \times 5}{30} = \frac{6 + 21 - 5}{30} = \frac{22}{30} = \frac{11}{15}
      \]
    \item \textbf{Comune denominatore (42):}
      \[
      5 - \frac{1}{2} + \frac{1}{3} - \frac{1}{6} + \frac{1}{7} = \frac{210 - 21 + 14 - 7 + 6}{42} = \frac{202}{42} = \frac{101}{21}
      \]
    \item \textbf{Comune denominatore (90):}
      \[
      \frac{44}{45} + \frac{17}{30} - \frac{2}{9} + \frac{1}{15} = \frac{88 + 51 - 20 + 6}{90} = \frac{125}{90} = \frac{25}{18}
      \]
    \item \textbf{Semplificazione e mcm (80):} Semplifichiamo $\frac{35}{50} = \frac{7}{10}$ e $\frac{5}{200} = \frac{1}{40}$:
      \[
      ...
      \[
      \frac{7 \times 8 - 15 \times 5 + 1 \times 4}{80} = \frac{56 - 75 + 4}{80} = -\frac{15}{80} = -\frac{3}{16}
      \]
    \item \textbf{Semplificazione e parentesi:} Semplifichiamo $\frac{21}{24} = \frac{7}{8}$ e $\frac{15}{36} = \frac{5}{12}$:
      \[
      ...
      \]
    \item \textbf{Semplificazione e parentesi:} Semplifichiamo $\frac{48}{36} = \frac{4}{3}$, $\frac{55}{44} = \frac{5}{4}$ e $\frac{6}{15} = \frac{2}{5}$:
      \[
      \frac{4}{3} - \left(\frac{5}{4} - \frac{2}{5}\right) = \frac{4}{3} - \left(\frac{25-8}{20}\right) = \frac{4}{3} - \frac{17}{20} = \frac{80-51}{60} = \frac{29}{60}
      \]
    \item \textbf{Semplificazione e parentesi:} Semplifichiamo $\frac{85}{15} = \frac{17}{3}$:
      \[
      8 - \left(\frac{17}{3} + \frac{5}{6}\right) = 8 - \left(\frac{34+5}{6}\right) = 8 - \frac{39}{6} = 8 - \frac{13}{2} = \frac{16-13}{2} = \frac{3}{2}
      \]
    \item \textbf{Semplificazione e parentesi:} Semplifichiamo $\frac{50}{40} = \frac{5}{4}$, $\frac{12}{18} = \frac{2}{3}$ e $\frac{8}{32} = \frac{1}{4}$:
      \[
      ...
      \]
    \item[l)] \textbf{Semplificazione e mcm (120):} Semplifichiamo $\frac{45}{72} = \frac{5}{8}$, $\frac{32}{48} = \frac{2}{3}$ e $\frac{10}{25} = \frac{2}{5}$:
      \[
      \frac{5}{8} - \left(\frac{2}{3} - \frac{2}{5}\right) - \frac{1}{40} = \frac{5}{8} - \frac{4}{15} - \frac{1}{40} = \frac{5 \times 15 - 4 \times 8 - 1 \times 3}{120} = \frac{75 - 32 - 3}{120} = \frac{40}{120} = \frac{1}{3}
      \]
    \item[m)] \textbf{Semplificazione e parentesi:} Semplifichiamo $\frac{55}{66} = \frac{5}{6}$ e $\frac{12}{16} = \frac{3}{4}$:
      \[
      \frac{17}{12} + \frac{5}{6} - \left(2 - \frac{3}{4}\right) = \frac{17+10}{12} - \frac{5}{4} = \frac{27}{12} - \frac{15}{12} = \frac{12}{12} = 1
      \]
    \item[n)] \textbf{Semplificazione e parentesi:} Semplifichiamo $\frac{4}{12} = \frac{1}{3}$:
      \[
...
\section*{3. Espressioni con le parentesi}



\begin{esercizio}{Espressioni con frazioni (livello base e intermedio)}
...
\begin{enumerate}[label=\alph*)]
  \item $\left( \frac{1}{2} + \frac{2}{3} \right) - \frac{5}{6}$
  \responsespace{3.0cm}
  
  \item $\frac{5}{4} - \left( \frac{1}{3} + \frac{1}{2} \right)$
  \responsespace{3.0cm}
  
  \item $2 - \left( \frac{3}{5} + \frac{7}{10} \right)$
  \responsespace{3.0cm}
  
  \item $\left( \frac{3}{2} - \frac{2}{3} \right) + \left( \frac{5}{4} - \frac{5}{6} \right)$
  \responsespace{3.0cm}

  \item $\frac{23}{10} - \left[ \frac{3}{5} - \left( \frac{1}{2} - \frac{1}{5} \right) \right]$
  \responsespace{3.0cm}
\end{enumerate}
...
\begin{soluzione}
  \textbf{Svolgimento passaggi:}
  \begin{enumerate}[label=\alph*)]
    \item Prima svolgiamo la parentesi tonda (comune denominatore 6):
      \[
      \left( \frac{3}{6} + \frac{4}{6} \right) - \frac{5}{6} = \frac{7}{6} - \frac{5}{6} = \frac{2}{6} = \frac{1}{3}
      \]
    \item Prima svolgiamo la parentesi tonda (comune denominatore 6):
      \[
      \frac{5}{4} - \left( \frac{2}{6} + \frac{3}{6} \right) = \frac{5}{4} - \frac{5}{6}
      \]
      Ora eseguiamo la sottrazione (comune denominatore 12):
      \[
      \frac{15}{12} - \frac{10}{12} = \frac{5}{12}
      \]
    \item Prima svolgiamo la parentesi tonda (comune denominatore 10):
      \[
      2 - \left( \frac{6}{10} + \frac{7}{10} \right) = 2 - \frac{13}{10}
      \]
      Ora calcoliamo la differenza con l'intero:
      \[
      \frac{20}{10} - \frac{13}{10} = \frac{7}{10}
      \]
    \item Svolgiamo contemporaneamente le due parentesi tonde:
      \begin{itemize}
        \item Prima tonda (comune denominatore 6): $\frac{3}{2} - \frac{2}{3} = \frac{9-4}{6} = \frac{5}{6}$
        \item Seconda tonda (comune denominatore 12): $\frac{5}{4} - \frac{5}{6} = \frac{15-10}{12} = \frac{5}{12}$
      \end{itemize}
      Ora sommiamo i due risultati (comune denominatore 12):
      \[
      \frac{5}{6} + \frac{5}{12} = \frac{10}{12} + \frac{5}{12} = \frac{15}{12} = \frac{5}{4}
      \]
    \item Risolviamo prima la tonda interna (comune denominatore 10):
      \[
      \frac{23}{10} - \left[ \frac{3}{5} - \left( \frac{5-2}{10} \right) \right] = \frac{23}{10} - \left[ \frac{3}{5} - \frac{3}{10} \right]
      \]
      Troviamo il comune denominatore nella quadra (10):
      \[
      \frac{23}{10} - \left[ \frac{6-3}{10} \right] = \frac{23}{10} - \frac{3}{10} = \frac{20}{10} = 2
      \]
  \end{enumerate}
\end{soluzione}
\end{esercizio}
...
\begin{esercizio}{Espressioni con frazioni (livello avanzato)}
Risolvi le seguenti espressioni complesse con frazioni, rispettando l'ordine delle parentesi e semplificando i calcoli intermedi.
...
\begin{enumerate}[label=\alph*)]
  ...
  \item $\frac{7}{12} + \frac{2}{3} + 2 - \left[ \frac{7}{4} - \frac{5}{6} - \left( 1 - \frac{1}{2} \right) \right] - \frac{5}{6}$
  \responsespace{3.0cm}
  ...
  \item $\left[ \frac{1}{2} + \frac{3}{4} - \left( \frac{1}{2} + \frac{3}{2} - \frac{5}{4} \right) \right] + \left[ \left( \frac{1}{3} - \frac{1}{6} \right) + \left( \frac{3}{2} - \frac{2}{3} \right) \right] - \left( 1 + \frac{1}{2} \right)$
  \responsespace{3.0cm}
...
\begin{soluzione}
  \textbf{Svolgimento passaggi:}
  \begin{enumerate}[label=\alph*)]
    \item \textbf{Prima espressione:}
      Risolviamo le due parentesi tonde:
      \[
      ...
      \]
    \item \textbf{Seconda espressione:}
      Svolgiamo la prima tonda interna alla quadra:
      \[
      ...
      \]
      Semplifichiamo $\frac{3}{12} = \frac{1}{4}$ nella seconda tonda e la calcoliamo:
      \[
      \frac{1}{2} + 6 + \frac{1}{4} = \frac{2 + 24 + 1}{4} = \frac{27}{4}
      \]
      Eseguiamo il calcolo finale:
      \[
      \frac{3}{4} + \frac{27}{4} - 2 = \frac{30}{4} - 2 = \frac{15}{2} - 2 = \frac{15-4}{2} = \frac{11}{2}
      \]
    \item \textbf{Terza espressione:}
      Semplifichiamo le frazioni nella prima tonda: $\frac{3}{15} = \frac{1}{5}$ e $\frac{6}{45} = \frac{2}{15}$.
      \[
      ...
      \]
      Semplifichiamo $\frac{18}{15} = \frac{6}{5}$ e calcoliamo la parentesi quadra:
      \[
      \left[ \frac{6}{5} - \frac{47}{45} \right] = \frac{54-47}{45} = \frac{7}{45}
      \]
      Eseguiamo il calcolo finale:
      \[
      \frac{4}{3} + \frac{7}{9} - \frac{14}{9} - \frac{7}{45} = \frac{4}{3} - \frac{7}{9} - \frac{7}{45} = \frac{60 - 35 - 7}{45} = \frac{18}{45} = \frac{2}{5}
      \]
    \item \textbf{Quarta espressione:}
      Semplifichiamo $\frac{3}{6} = \frac{1}{2}$ nella prima tonda e la calcoliamo:
      \[
      ...
      \[
      \frac{1}{6} + \frac{3}{4} + 1 - \frac{5}{6} = \frac{3}{4} + 1 - \frac{4}{6} = \frac{3}{4} + 1 - \frac{2}{3} = \frac{9 + 12 - 8}{12} = \frac{13}{12}
      \]
      ...
      Eseguiamo il calcolo finale:
      \[
      \frac{2}{3} + \frac{5}{4} - \frac{7}{4} + \frac{7}{12} = \frac{2}{3} - \frac{2}{4} + \frac{7}{12} = \frac{2}{3} - \frac{1}{2} + \frac{7}{12} = \frac{8-6+7}{12} = \frac{9}{12} = \frac{3}{4}
      \]
    \item Svolgiamo prima la tonda interna:
      \[
      \frac{7}{12} + \frac{2}{3} + 2 - \left[ \frac{7}{4} - \frac{5}{6} - \left( 1 - \frac{1}{2} \right) \right] - \frac{5}{6}
      \]
      Troviamo il comune denominatore nella quadra (12):
      \[
      \frac{7}{12} + \frac{2}{3} + 2 - \left[ \frac{21-10-6}{12} \right] - \frac{5}{6} = \frac{7}{12} + \frac{2}{3} + 2 - \frac{5}{12} - \frac{5}{6}
      \]
      Eseguiamo i calcoli finali con comune denominatore (12):
      \[
      \frac{7 + 8 + 24 - 5 - 10}{12} = \frac{24}{12} = 2
      \]
    ...
    \item Svolgiamo prima le tre parentesi tonde:
      ...
      \]
    \item Svolgiamo le singole parentesi tonde ed eseguiamo le operazioni interne:
      1. $\frac{1}{2} + \frac{3}{2} - \frac{5}{4} = \frac{2+6-5}{4} = \frac{3}{4}$ \\
      2. $\frac{1}{3} - \frac{1}{6} = \frac{1}{6}$ \ e \ $\frac{3}{2} - \frac{2}{3} = \frac{5}{6}$ \\
      3. $1 + \frac{1}{2} = \frac{3}{2}$ \\
      Sostituiamo e semplifichiamo:
      * Prima quadra: $\left[ \frac{1}{2} + \frac{3}{4} - \frac{3}{4} \right] = \frac{1}{2}$ \\
      * Seconda quadra: $\left[ \frac{1}{6} + \frac{5}{6} \right] = \frac{6}{6} = 1$ \\
      Eseguiamo il calcolo finale: $\frac{1}{2} + 1 - \frac{3}{2} = \frac{1+2-3}{2} = 0$
...
\section*{4. Problemi con le frazioni}
...
\begin{soluzione}
  ...
  \begin{tikzpicture}[scale=0.85]
    \fill[blue!20!white] (0,0) rectangle (3.0, 0.4); % 12 blocks for Girls (2/5 = 12/30)
    \fill[orange!25!white] (3.0,0) rectangle (5.5, 0.4); % 10 blocks for Boys (1/3 = 10/30)
    \fill[red!20!white] (5.5,0) rectangle (6.25, 0.4); % 3 blocks for Teacher (1/10 = 3/30)
    \fill[green!20!white] (6.25,0) rectangle (7.5, 0.4); % 5 blocks for Parents (1/6 = 5/30)
    \draw[thick, mainblue] (0,0) rectangle (7.5,0.4);
    \foreach \x in {1,...,29} {
      \draw[linegray, thin] (0.25*\x, 0) -- (0.25*\x, 0.4);
    }
    \node[scale=0.75] at (1.5, 0.2) {\textbf{Ragazze} ($\frac{12}{30}$)};
    \node[scale=0.75] at (4.25, 0.2) {\textbf{Ragazzi} ($\frac{10}{30}$)};
    \node[scale=0.7] at (5.875, 0.2) {\textbf{Prof} ($\frac{3}{30}$)};
    \node[scale=0.75] at (6.875, 0.2) {\textbf{Genitori} ($\frac{5}{30}$)};
  \end{tikzpicture}
  \end{center}
    ...
    \item \textbf{Quantità in grammi:}
      \begin{itemize}
        ...
        \item Calcoliamo la parte rimasta:
          \[
          1200\unita{g} \times \frac{1}{6} = \frac{1200}{6}\unita{g} = 200\unita{g}
          \]
      \end{itemize}
  \end{enumerate}
  \textbf{Risposta:} a) In totale è stata consumata la frazione $\frac{5}{6}$ della torta; b) Rimane la frazione $\frac{1}{6}$; c) Ai genitori sono rimasti $200\unita{g}$ di torta.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{center}
  \begin{tikzpicture}[scale=0.85]
    \fill[blue!20!white] (0,0) rectangle (2.0, 0.4); % 4 blocks for Fruttivendolo (2/7 = 4/14)
    \fill[orange!25!white] (2.0,0) rectangle (3.5, 0.4); % 3 blocks for Panettiere (3/14)
    \fill[green!20!white] (3.5,0) rectangle (7.0, 0.4); % 7 blocks Rimanenti (1/2 = 7/14)
    \draw[thick, mainblue] (0,0) rectangle (7.0, 0.4);
    \foreach \x in {1,...,13} {
      \draw[linegray, thin] (0.5*\x, 0) -- (0.5*\x, 0.4);
    }
    \node[scale=0.75] at (1.0, 0.2) {\textbf{Fruttivendolo} ($\frac{4}{14}$)};
    \node[scale=0.75] at (2.75, 0.2) {\textbf{Panettiere} ($\frac{3}{14}$)};
    \node[scale=0.75] at (5.25, 0.2) {\textbf{Denaro rimanente} ($\frac{7}{14} = \frac{1}{2}$)};
  \end{tikzpicture}
  \end{center}
    ...
    \item \textbf{Calcolo dell'importo rimanente in euro (budget = $56$ euro):}
      \begin{itemize}
        \item Calcoliamo la metà di $56$ euro:
          \[
          56\text{ euro} \times \frac{1}{2} = \frac{56}{2}\text{ euro} = 28\text{ euro}
          \]
      \end{itemize}
  \end{enumerate}
  \textbf{Risposta:} a) Ha speso la frazione $\frac{1}{2}$ del denaro totale; b) Le rimane la frazione $\frac{1}{2}$ del denaro; c) Nel portafoglio le rimangono esattamente $28$ euro.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{center}
  \begin{tikzpicture}[scale=0.85]
    \fill[blue!20!white] (0,0) rectangle (4.8, 0.4); % 12 blocks for Treno (3/5 = 12/20)
    \fill[orange!25!white] (4.8,0) rectangle (6.8, 0.4); % 5 blocks for Autobus (1/4 = 5/20)
    \fill[green!20!white] (6.8,0) rectangle (8.0, 0.4); % 3 blocks a piedi (3/20)
    \draw[thick, mainblue] (0,0) rectangle (8.0, 0.4);
    \foreach \x in {1,...,19} {
      \draw[linegray, thin] (0.4*\x, 0) -- (0.4*\x, 0.4);
    }
    \node[scale=0.75] at (2.4, 0.2) {\textbf{Treno} ($\frac{12}{20}$)};
    \node[scale=0.75] at (5.8, 0.2) {\textbf{Autobus} ($\frac{5}{20}$)};
    \node[scale=0.75] at (7.4, 0.2) {\textbf{A piedi} ($\frac{3}{20}$)};
  \end{tikzpicture}
  \end{center}
    ...
    \item \textbf{Distanza a piedi:}
      \begin{itemize}
        \item Calcoliamo la distanza in km sapendo che l'intero tragitto misura $80\unita{km}$:
          \[
          80\unita{km} \times \frac{3}{20} = \frac{80 \times 3}{20}\unita{km} = 4 \times 3\unita{km} = 12\unita{km}
          \]
      \end{itemize}
  \end{enumerate}
  \textbf{Risposta:} a) I $\frac{17}{20}$ del percorso totale; b) I $\frac{3}{20}$ del percorso; c) Percorrono $12\unita{km}$ a piedi.
\end{soluzione}
\end{esercizio}
...
\begin{soluzione}
  ...
  \begin{center}
  \begin{tikzpicture}[scale=0.85]
    \fill[blue!20!white] (0,0) rectangle (3.0, 0.4); % 3 blocks for A piedi (1/2 = 3/6)
    \fill[orange!25!white] (3.0,0) rectangle (5.0, 0.4); % 2 blocks for Bicicletta (1/3 = 2/6)
    \fill[green!20!white] (5.0,0) rectangle (6.0, 0.4); % 1 block for Mezzi pubblici (1/6)
    \draw[thick, mainblue] (0,0) rectangle (6.0, 0.4);
    \foreach \x in {1,...,5} {
      \draw[linegray, thin] (1.0*\x, 0) -- (1.0*\x, 0.4);
    }
    \node[scale=0.75] at (1.5, 0.2) {\textbf{A piedi} ($\frac{3}{6}$)};
    \node[scale=0.75] at (4.0, 0.2) {\textbf{Bici} ($\frac{2}{6}$)};
    \node[scale=0.75] at (5.5, 0.2) {\textbf{Mezzi} ($\frac{1}{6}$)};
  \end{tikzpicture}
  \end{center}
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item \textbf{Numero di alunni per gruppo (totale = 24 allievi):}
      \begin{itemize}
        \item \textbf{A piedi:} $24 \times \frac{1}{2} = 12$ alunni.
        \item \textbf{In bicicletta:} $24 \times \frac{1}{3} = 8$ alunni.
        \item \textbf{Mezzi pubblici:} $24 \times \frac{1}{6} = 4$ alunni.
      \end{itemize}
      Verifica: $12 + 8 + 4 = 24$ alunni.
  \end{enumerate}
  \textbf{Risposta:} a) I mezzi pubblici rappresentano la frazione $\frac{1}{6}$; b) Ci sono $12$ alunni a piedi, $8$ alunni in bicicletta e $4$ alunni con i mezzi pubblici.
\end{soluzione}
\end{esercizio}
...
\begin{tikzpicture}[scale=1.0]
  ...
  \draw[thick, mainblue] (0,0) rectangle (8,0.8);
  
  % Internal divisions
  \draw[thick, mainblue] (2,0) -- (2,0.8);
  \draw[thick, mainblue] (6,0) -- (6,0.8);
  \draw[dashed, linegray] (4,0) -- (4,0.8); % Sofia's half line for reference
  
  % Annotations below the bar for student/solution
  \ifsoluzioni
    \fill[blue!15!white] (0,0) rectangle (2,0.8);
    \fill[orange!15!white] (2,0) rectangle (6,0.8);
    \fill[green!15!white] (6,0) rectangle (8,0.8);
    
    \draw[thick, mainblue] (0,0) rectangle (8,0.8);
    \draw[thick, mainblue] (2,0) -- (2,0.8);
    \draw[thick, mainblue] (6,0) -- (6,0.8);
    
    \node at (1,0.4) {\small\textbf{Matteo}};
    \node at (1,-0.4) {\small $\frac{1}{4}$ ($100\unita{m}$)};
    
    \node at (4,0.4) {\small\textbf{Sofia}};
    \node at (4,-0.4) {\small $\frac{1}{2}$ ($200\unita{m}$)};
    
    \node at (7,0.4) {\small\textbf{Luca}};
    \node at (7,-0.4) {\small $\frac{1}{4}$ ($100\unita{m}$)};
  \else
    \node at (1,0.4) {\small\textbf{Matteo}};
    \node at (4,0.4) {\small\textbf{Sofia}};
    \node at (7,0.4) {\small\textbf{Luca}};
  ...
  \begin{enumerate}[label=\alph*)]
    \item \textbf{Ragionamento con i blocchetti (Spiegazione):} Poiché a Luca spetta $\frac{1}{4}$ del tracciato (l'ultimo blocco), la parte restante per Matteo e Sofia insieme è $1 - \frac{1}{4} = \frac{3}{4}$ della pista.
      ...
      \begin{itemize}
        ...
        \item Di conseguenza, Matteo corre $\frac{1}{4}$, Sofia corre $2$ blocchi cioè $2 \times \frac{1}{4} = \frac{2}{4} = \frac{1}{2}$ (che corrisponde esattamente a **metà dell'intero percorso**!), e Luca corre $\frac{1}{4}$.
      \end{itemize}
    \item \textbf{Calcolo delle distanze reali (totale = $400\unita{m}$):}
      Utilizzando lo schema a blocchi o le frazioni ricavate:
      \begin{itemize}
        \item \textbf{Matteo:} corre $\frac{1}{4}$ del percorso: $400\unita{m} \times \frac{1}{4} = 100\unita{m}$.
        \item \textbf{Sofia:} corre $\frac{1}{2}$ del percorso: $400\unita{m} \times \frac{1}{2} = 200\unita{m}$.
        \item \textbf{Luca:} corre $\frac{1}{4}$ del percorso: $400\unita{m} \times \frac{1}{4} = 100\unita{m}$.
      \end{itemize}
      Verifica: $100\unita{m} + 200\unita{m} + 100\unita{m} = 400\unita{m}$.
  \end{enumerate}
  \textbf{Risposta:} a) Sofia corre metà percorso ($\frac{1}{2}$) perché togliendo la quota di Luca ($\frac{1}{4}$) i restanti $\frac{3}{4}$ sono divisi in 3 blocchi uguali (1 per Matteo, 2 per Sofia); b) Matteo corre $100\unita{m}$, Sofia corre $200\unita{m}$, Luca corre $100\unita{m}$.
\end{soluzione}
\end{esercizio}
  ...
  \begin{enumerate}[label=\alph*)]
    \item \textbf{Calcolo della frazione iniziale F:}
      ...
      \begin{itemize}
        ...
        \item Aumento dovuto alla pioggia diretta: $\frac{1}{4}$ del volume preesistente, ossia $\frac{1}{4} \times F$. L'acqua iniziale più l'aumento diretto diventa:
          \[
      ...
      \[
      F = \frac{1}{2} \times \frac{4}{5} = \frac{4}{10} = \frac{2}{5}
      \]
    ...
    \item \textbf{Calcolo dei litri (capacità totale = $2000\unita{l}$):}
      ...
      \begin{itemize}
        \item \textbf{Volume iniziale d'acqua:} $\frac{2}{5} \times 2000\unita{l} = 2 \times 400\unita{l} = 800\unita{l}$.
        \item \textbf{Volume finale d'acqua:} $\frac{3}{5} \times 2000\unita{l} = 3 \times 400\unita{l} = 1200\unita{l}$.
        \item \textbf{Litri totali aggiunti:} $1200\unita{l} - 800\unita{l} = 400\unita{l}$.
      \end{itemize}
  \end{enumerate}
  \textbf{Risposta:} a) Frazione iniziale $F = \frac{2}{5}$; b) All'inizio c'erano $800$ litri d'acqua; in totale sono stati aggiunti $400$ litri durante la notte.
\end{soluzione}
\end{esercizio}
...
Esegui i seguenti calcoli di riepilogo con le frazioni e riduci sempre i risultati ai minimi termini. Colorando nella figura sottostante solo i settori che contengono i risultati esatti che hai trovato, scoprirai una vignetta misteriosa!
...
\begin{soluzione}
  ...
  \end{enumerate}
  \textbf{Vignetta:} Colorando solo le sezioni corrispondenti a questi 14 risultati esatti, si completerà il disegno della vignetta (che rappresenta una simpatica lucertola/drago tra le foglie).
\end{soluzione}
\end{esercizio}
